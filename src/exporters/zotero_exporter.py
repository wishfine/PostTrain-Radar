...
class ZoteroExporter(BaseExporter):
    def test_connection(self) -> bool:
        print("[!] ZoteroExporter is not implemented in v0.1.")
        return False

    def export_paper_note(self, paper: dict, markdown_content: str, overwrite: bool = False) -> bool:
        warnings.warn("ZoteroExporter is a stub in v0.1. Export skipped.", UserWarning)
        return False
